...
?>
		<form id="adv-settings" method="post">
			<fieldset class="metabox-prefs">
				...
				?>
						<label for="<?php echo $key; ?>-hide"><input class="hide-postbox-tog" name="<?php echo $key; ?>-hide" type="checkbox" id="<?php echo $key; ?>-hide" value="<?php echo $key; ?>" <?php
...
function qsm_generate_dashboard_page()
{
	...
	?>
	<div class="wrap">
		<h1><?php _e('Daily Sportsbd Dashboard', 'quiz-master-next'); ?></h1>
		<div id="welcome_panel" class="postbox welcome-panel <?php qsm_check_close_hidden_box('welcome_panel'); ?>">
			<div class="qsm-welcome-panel-close">
				<br/>
				<img src="https://dailysportsbd.com/quiz/wp-content/uploads/2021/01/cropped-dailysportsbd-fb.png">
			...
			<div class="welcome-panel-content">
				<h2><?php _e('Welcome to Daily Sportsbd Quiz', 'quiz-master-next'); ?></h2>
